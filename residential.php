...
<head>
    ...
    <title>Residential-Tendercare Management Ltd</title>
...
<body  class="bg-[#F7F7F7]">
    ...
    <section class="bg-[#F7F7F7]">
        ...
        <div class="w-full flex flex-wrap justify-around px-5">
            <div id="cliping"
                class="lg:w-[65%] w-full lg:h-[1360px] h-auto md:h-auto sm:h-auto bg-white text-black flex flex-col justify-center items-center p-4">

                <p class='text-justify text-[13px] md:text-[15px]  mt-32  text-[#737373]'>
                   If you are in need of help on an essay, consider using an essay
                        service. These services are
                        affordable and provide high quality writing.<a
                        href='https://writing-essays.org/cheap-essay-writing/'
                        class='cursor-pointer text-[#F0CD80]'>.The first step in your cheap custom essay writing
                        process is to think about the topic or question you are going to address.</a>
                       It is best to look
                        for companies which have been in operation for a while. It should be reliable and offer a
                        money-back
                        assurance or a quality warranty.
                </p>
                <img src="img/old.jpg" alt="Meeting"
                    class=" lg:mt-9 mt-2 lg:w-[750px] md:w-[500px] sm:w-[400px] w-[300px]">

                <div class=" text-[13px] md:text-[15px] ">
                    <p class='text-justify mt-4 w-[97%] text-[#737373]'>
                        At TCM Care, our philosophy adopts the person-centred approach, so when delivering day-to-day
                        care practice, the identity of an individual is at the centre of what we do. As a result of
                        fostering a model of care that looks at the ‘whole person’ – and not a person’s ability or
                        medical capacity; TCM Care continues to uphold a commitment to offering peace of mind to both an
                        individual and their family alike. </p>

                    <p class='text-justify mt-4 w-[97%] text-[#737373]'>
                        Each TCM Care Home provides a place where individuals can flourish within a supportive and
                        enabling environment: one that offers friendship, an enriching engagement programme, and the
                        opportunity to maintain links with the wider community. </p>
                    <p class='text-justify mt-4 w-[97%] text-[#737373]'>
                        Furthermore, each member of staff at TCM Care is committed to delivering a service that knows
                        more than just an individual’s name and face. With the support of a bespoke initial assessment,
                        use of Person Centred Software (Mobile Care Monitoring) – an intelligent mobile solution for
                        care planning, reporting and care interactions – and ongoing reviews and evaluations regarding a
                        person’s priorities and preferences, staff can continue to deliver the highest quality of care
                        in line with the company’s over-arching person-centred philosophy as well as providing staffing
                        solutions to private care homes across London. </p>

                    <ul class="list-disc text-[#737373] list-inside pt-3 md:pt-5">
                        <li>Healthcare Care Assistant</li>
                        <li class="mt-2">Support Workers</li>
                        <li class="mt-2">Senior Supports</li>
                        <li class="mt-2">Home Care Managers</li>
                        <li class="mt-2">Senior Carers</li>
                        <li class="mt-2">Clinical HCAs</li>
                        <li class="mt-2">Carer Supports</li>
                        <li class="mt-2">Nurses</li>
                    </ul>
                </div>
