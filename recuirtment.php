...
<head>
    ...
    <title>Recruitment-Tendercare Management Ltd</title>
...
<section class="bg-[#F7F7F7]">
    <div id="clip" class="w-full lg:h-[450px] h-[480px] md:h-[450px] sm:h-[450px] bg-[#6F6F6F] text-[#D4B068] flex flex-col justify-center items-center">
    ...
    <div class="w-full flex flex-wrap justify-around px-5">
        <div id="cliping" class="lg:w-[65%] w-full lg:h-[1050px] h-auto md:h-auto sm:h-auto bg-white text-black flex flex-col justify-center items-center p-4">
            
            <!-- Replace "path/to/image" with the actual image URL or relative path -->
            <img src="img/meeting.jpg" alt="Meeting" class="py-9 lg:mt-9 mt-10 lg:w-[750px] md:w-[500px] sm:w-[400px] w-[300px]">

            <p class="lg:w-[95%] w-full mt-5">TCM Ltd works with a range of businesses in and around London and surrounding areas, from SMEs through to larger organisations.</p>
            <p class="lg:w-[95%] w-full mt-5">Our London recruitment agency sources business support staff for a range of industries and sectors.</p>
            <p class="lg:w-[95%] w-full mt-5">Get in touch to find out more.</p>
            <p class="lg:w-[95%] w-full mt-5">
                Essays can be described as a form of writing which provides explanation and arguments on certain subjects. The most well-known type of academic writing may be utilized to help professionals and students be able to communicate clearly and effectively.
                <a href="https://essaysonline.org/" target="_blank" rel="noopener noreferrer" class="text-[#D4B068] cursor-pointer">
        ...
        <div id="clipings" class="hidden lg:flex w-[25%] lg:h-[60px] h-[40px] bg-white text-[#D4B068] flex-col justify-center items-center mt-[-40px]"></div>
    </div>
</section>
