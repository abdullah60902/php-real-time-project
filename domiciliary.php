...
<head>
    ...
    <title>Domiciliary-Tendercare Management Ltd</title>
...
<section class="bg-[#F7F7F7]">
    ...
    <div class="w-full flex flex-wrap justify-around px-5">
        <div id="cliping" class="lg:w-[65%] w-full lg:h-[1000px] h-auto md:h-auto sm:h-auto bg-white text-black flex flex-col justify-center items-center p-4">
            
            <!-- Replace "path/to/image" with the actual image URL or relative path -->
            <img src="img/care-staff.jpg" alt="Meeting" class="py-9 lg:mt-9 mt-10 lg:w-[750px] md:w-[500px] sm:w-[400px] w-[300px]">
             
            <div class="text-[#afa4a4] text-[12px] md:text-[14px] pt-5 md:pt-10">
                                <p class="text-[14px] md:text-[16px] font-extralight text-[#0000007c]">
                                    We have a huge number of staff in our database covering
                                    a variety of specialities including the following:
                                </p>
                                <ul class="list-disc list-inside pt-3 md:pt-5">
