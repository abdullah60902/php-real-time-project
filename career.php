...
<head>
    ...
    <title>Career-Tendercare Management Ltd</title>
...
<body class="bg-[#F7F7F7]">
    ...
    <div id="mobile-sidebar"
        ...
        <div class="flex flex-col items-start space-y-4">
            <a href="index.php#home" class="w-[100%]">
    ...
    <div class="flex justify-center mt-28 items-start py-16 px-4 overflow-hidden">
        <!-- Main Container -->
        <div class="bg-[#1F1F1F] max-w-5xl w-full p-6 md:p-10 rounded-lg shadow-lg">
            <div class="flex flex-col lg:flex-row gap-8 md:gap-10">
                <!-- Left Section - Text -->
                <div class="lg:w-1/2">
                    <h1 class="text-3xl md:text-4xl font-bold mb-4 text-[#ffffff]">Apply For the Job</h1>
                    <div class="border-t-4 border-[#ffffff] w-20 mb-4"></div>
                    <div class="flex flex-col items-start gap-4 mb-6">
                        <div class="bg-[#002a4800] w-10 h-10 flex items-center justify-center">
                            <i class="fa-solid fa-location-dot text-[#D4B068] text-[35px] mb-4"><img src="img/location.png" alt=""></i>
                        </div>
                        <div class="text-base md:text-lg text-[#ffffff]">
                            <p>
                ...
                <div class="lg:w-1/2">
                    <div class="">
                        <form method="POST" action="process.php" enctype="multipart/form-data" class="grid grid-cols-1 gap-6 p-4">
                            <input
                                type="text"
                                id="name"
                                name="name"
                                ...
                                required
                                class="bg-[#ffffff] px-2 py-3.5 w-full text-black rounded-lg border-2 transition-colors duration-100 border-solid focus:border-[#D4B068] border-[#1F1F1F]"
                            />
                            <input
                                type="email"
                                id="email"
                            ...
                            <div class="col-span-1">
                                <label class="block text-white text-sm font-semibold mb-2">Upload CV</label>
                                <input
                                id="image"
                                    type="file"
                            ...
                            <button
                                type="submit"
                                class="bg-[#78787881] text-white font-bold py-3 px-6 w-full transition-colors duration-200 hover:bg-[#868585cc] outline outline-1 focus:ring-2 focus:ring-[#fcfafa] focus:ring-opacity-50"
                            >
                                APPLY NOW
                            </button>
                        </form>
